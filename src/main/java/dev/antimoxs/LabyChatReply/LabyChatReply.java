...
public class LabyChatReply extends LabyModAddon {
    ...
    public void onEnable() {
        ...
        LabyMod.getInstance().getEventService().registerListener(new OnMessageSendListener(this));
    ...
    protected void fillSettings(List<SettingsElement> list) {
        ...
        BooleanElement cfcToggle = new BooleanElement("Toggle custom friend commands", this, new ControlElement.IconData(Material.PLAYER_HEAD), "LCR_CFC_TOGGLE", this.cfcToggl);
        //HeaderElement upnext = new HeaderElement("Up next: Custom commands for direct messages");

        HeaderElement cfc_note = new HeaderElement(TextFormatting.BOLD + "Custom friend commands");
        HeaderElement cfc_note1 = new HeaderElement(TextFormatting.ITALIC + "Syntax: '<Name> <cmd>;<Name> <cmd>;...'");
        ...
        ButtonElement cfc_clear = new ButtonElement("Reload syntax-list", new ControlElement.IconData(Material.REDSTONE), "Reload", this::loadCFC);
